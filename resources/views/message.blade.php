                ...
                <div class="messege_box">
                    ...
                    <div class="messege_block">
                        <div class="mes_fren">
                                ...
                                <form action="" class="search_fren">
                                    <input placeholder="Найти переписку" class="search" type="text">
                                    <input class="search_send" type="submit" value="⌕">
                                </form>
    
                                <div class="fren_s">
                                    <div class="fren_block">
    
                                        <div class="fren">
                                            <div class="inf_send">
                                                <div class="frend_img">
                                                    <img src="img/mes/mes_avat.png" alt="">
                                                </div>
                                                <div class="last_send_m">
                                                    <div class="nick">
                                                        <p>Wile</p>
                                                    </div>
                                                    <div class="last_send">
                        ...
                        <div class="mes_send">
                            <div class="mes_send_inf">
                                <div class="name">
                                    <p>Wile</p>
                                </div>
                                <div class="buttons_send">
                                    <a href="profile.html"><img src="img/mes/profile.svg" alt="">Профиль</a>
                                    <a href=""><img src="img/mes/del.svg" alt="">Удалить</a>
                                </div>
                            </div>
    
                            <div id="block" class="mes_block_s">
                                <div class="mes_block_m">
    
                                    <div class="your_mes">
                                        <div class="m_block">
                                            <div class="inf_mes_prof">
                                                <div class="i_mt">
                                                    <div class="img_mes_prof">
                                                        <img src="img/mes/mes_avat.png" alt="">
                                                    </div>
                                                    <div class="inf_mes_text">
                                                        <p class="name_mes_n">Wile</p>
                                                        <p class="last_send_mes">Привет!</p>
                                                    </div>
                                                </div>
                                                <div class="date_send">
                                                    <p>12.06.2023</p>
                                        ...
                                        <div class="m_block ">
                                            <div class="inf_mes_prof">
                                                <div class="i_mt">
                                                    ...
                                                    <div class="inf_mes_text">
                                                        <p class="name_mes_n">Wile</p>
                                                        <p class="last_send_mes">ssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssss</p>
                                                    </div>
                                                </div>
                                                <div class="date_send">
                                                    <p>12.06.2023</p>
                            ...
                            <form class="mes_send_inp" action="">
                                <input class="send_mes" placeholder="Введите сообщение" type="text">
                                <input class="btn_mes" type="submit" value="ОТП">
                            </form>
