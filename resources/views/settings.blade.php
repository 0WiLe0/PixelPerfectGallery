        ...
        <div class="container">
            ...
            <div class="settings">
                ...
                <div class="settings_block">
                    <div class="set_block_container">
                        <div class="set_col_sl">
                            <div class="set_col">
                                <div class="pal_col">
                                    <div class="pal_col_title">
                                        <h3>Выберете тему для сайта</h3>
                                    </div>
                                    <div class="color_buttons">
                                        <button><div class="color_black"></div></button>
                                        <button><div class="color_red"></div></button>
                                        <button><div class="color_blue"></div></button>
                                    </div>
                                </div>  
                            </div>
                            <div class="col_sl">
                                ...
                                <div class="color_sl">
                                    <a href=""><img src="img/settings/vk.svg" alt=""></a>
                                    <a href=""><img src="img/settings/you.svg" alt=""></a>
                                    <a href=""><img src="img/settings/tel.svg" alt=""></a>
                                </div>
                            </div>
                        </div>
                        <div class="set_ad">
                            <div class="pal_col_title">
                                <h3>Изменить адреса профиля</h3>
                            </div>
                            <form action="">
                                <input class="red_inp" placeholder="www.pixelperfectgallery.com/profile/Wile" type="text">
                                <input class="red_btn" type="submit" value="Изменить">
                            </form>
                        </div>
                        <div class="set_del_teh">
                            <div class="set_del">
                                <div class="pal_col_title">
                                    <h3>Удаление аккаунта</h3>
                                </div>
                                <div class="b_del">
                                    <a class="del" href="">Удалить аккаунта</a>
                                </div>
                            </div>
                            <div class="set_teh">
                                <div class="pal_col_title">
                                ...
                                <div class="b_teh">
                                    <a class="teh" href="">Написать в тех поддержку</a>
                                </div>
                            </div>
                        </div>
                    </div>
